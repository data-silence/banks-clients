...
def nun_distribution():
    ...
    st.caption(
        'В данным нет пропусков, это обусловлено самой сборкой датасета, что описано в ноутбуке. Ну вот, '
...
def pearson_correlation():
    ...
    st.caption(
        ...
        'это совершенно понятно. Но вот корреляция между числовыми признаками и целевой переменной отсутствует '
